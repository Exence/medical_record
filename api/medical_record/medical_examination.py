...
@router.post('/get')
async def get_medical_examination(medical_examination_data: JsonForm,  service: MedicalExaminationService = Depends()):
...
@router.post('/add')
async def add_extra_class(medical_examination_data: JsonForm,  service: MedicalExaminationService = Depends()):
    medical_examination = medical_examination_data.json_data
    age = service.add_new_medical_examination(medical_examination)
    return {"age": age}

@router.post('/update')
async def update_medical_examination(medical_examination_data: JsonForm,  service: MedicalExaminationService = Depends()):
    medical_examination = medical_examination_data.json_data
    age = service.update_medical_examination(medical_examination)
    return {"age": age}

@router.post('/delete')
async def delete_medical_examination(medical_examination_data: JsonForm,  service: MedicalExaminationService = Depends()):
    medical_examination = medical_examination_data.json_data
